                ...
                <td style="margin-bottom:15px" align="left" bgcolor="#fff">
                    <div style="padding:20px">
                        <p style="color:#383838;font-size:16px; line-height:1.45em; margin-top:16px; margin-bottom:16px;">
                            ...
                            Não consegue acessar sua conta na <?= CONF_SITE["NAME"]; ?> e precisa redefinir sua senha?<br><br>

                            Então clique em redefinir minha senha para trocar sua senha!<br><br>

                            <b>IMPORANTE</b>:<br> Caso não tenha efetuado esta solicitação basta ignorar este e-mail e nenhuma alteração será feita em sua conta.<br><br>
