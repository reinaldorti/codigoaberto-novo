    ...
    <div class="blog_right_sidebar">
        ...
        <aside class="single_sidebar_widget instagram_feeds">
            ...
            <ul class="instagram_row flex-wrap">
                ...
                <li>
                    <a href="#">
                        <img class="img-fluid" src="<?= asset("assets/img/post/post_10.pn"); ?>g" alt="">
                    </a>
                </li>
            </ul>
        </aside>
        ...
        <aside class="single_sidebar_widget newsletter_widget">
            <h4 class="widget_title">Fique pro dentro</h4>

            <form action="#">
                <div class="form-group">
                    <input type="email" class="form-control" placeholder="Enter email" required>
                </div>
                <button class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn" type="submit">Assinar</button>
            </form>
        </aside>
    </div>
</div>