...
var effectsEffectTransfer=effect}));$(function(){$("[data-cookie]").click(function(e){e.preventDefault();var cookiePolicy=$("#cookiePolicy");var route=$(this).data("route");var dataset=$(this).data();$(".main_footer").css("margin-bottom",0);cookiePolicy.fadeOut();$.post(route,dataset,function(response){if(response.agree){window.location.reload()}},"json")});var cookiePolicy=$("#cookiePolicy");if(!cookiePolicy.hasClass("ds-none")){$(".main_footer").css("margin-bottom",cookiePolicy.outerHeight())}
$("form:not('.ajax_off')").submit(function(e){e.preventDefault();var form=$(this);var action=form.attr("action");var data=form.serialize();if(typeof tinyMCE!=='undefined'){tinyMCE.triggerSave()}
