        ...
        <table cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto">
            ...
            <tr bgcolor="#fff">
                <td align="center" bgcolor="#fff">
                    <a title="Acessar " href="<?= $link; ?>" style="color: #ffffff!important; display: inline-block; font-weight: 500; font-size: 16px; line-height: 42px; width: auto; white-space: nowrap; min-height: 42px; margin: 12px 5px 12px 0; padding: 0 22px; text-decoration: none; text-align: center!important; border: 0; border-radius: 3px; vertical-align: top; background-color: #5d5d5d!important" target="_blank">
                        <span style="display: inline; text-decoration: none; font-weight: 500; font-style: normal; font-size: 16px; line-height: 42px; border: none; color: #ffffff!important">ACESSAR SITE</span>
                    </a>
                </td>
            </tr>
            <tr>
